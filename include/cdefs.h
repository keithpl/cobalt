...
/*
 * Primarily a helper for `ssizeof()`; asserts at compile time that `sizeof(x)`
 * safely fits within a `ptrdiff_t`.
 *
...
/*
 * Signed variant of `sizeof()`, expanding to a value of `ptrdiff_t`.
 *
